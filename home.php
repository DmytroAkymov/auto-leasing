    ...
    <div class="container">
      ...
      <div class="services__inner">
        <div class="services__content">
          <?php the_field('text_ours_services'); ?>
<!--           
    ...
    <div class="container">
      <div class="contacts__inner">
        <div class="contacts__info">
          ...
          <ul class="contacts__list">
            ...
            <li class="contacts__item">
              ...
              <p class="contacts__item-text" href="tel:<?php the_field('call_number'); ?>">
                <?php the_field('phone'); ?>
              </p>
            </li>
          </ul>
        ...
        <form class="contacts__form">
          ...
          <?php echo do_shortcode('[contact-form-7 id="5301bd5" title="Contact form"]' )?>
        </form>
      </div>
    </div>
  </section>
